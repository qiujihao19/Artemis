...
from artemis.constants import DEFAULT_IM_START_TOKEN, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_END_TOKEN, IMAGE_TOKEN_INDEX, DEFAULT_VID_START_TOKEN, DEFAULT_VID_END_TOKEN
...
def run_inference(args):
    ...
    for sample in tqdm(gt_questions):
        ...
        video_clip_name = f"v_{video_name}{'.pkl'}"
        ...
        if os.path.exists(video_feature_path):
            ...
            try:
                output = get_model_output(model, processor['video'], tokenizer, video_clip, question, args)
